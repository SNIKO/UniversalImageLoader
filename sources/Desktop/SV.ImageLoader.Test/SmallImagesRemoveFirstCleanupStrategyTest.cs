...
namespace SV.ImageLoader.Test
{
    ...
    [TestClass]
    public class SmallImagesRemoveFirstCleanupStrategyTest : CacheCleanupStrategyTest
    {
        [TestMethod]
        public void GetItemsToCleanup_SomeItemsAreSpecified_ReturnItemsAccordingToStrategy()
        {
            var strategy = new SmallImagesRemoveFirstCleanupStrategy();
            ...
            var expectedItems = new[] { cacheItems["McLaren"][0], cacheItems["McLaren"][1], cacheItems["MU"][0], cacheItems["Magnussen"][0] };
            var itemsToDelete = strategy.GetItemsToCleanup(cacheItems, i => i.Size, 90);
