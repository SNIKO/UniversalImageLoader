...
namespace SV.ImageLoader
{
    ...
    public interface ICacheCleanupStrategy
    {
        ...
        /// </returns>
        IEnumerable<CacheImageLoader.CacheItem> GetItemsToCleanup(IReadOnlyDictionary<string, List<CacheImageLoader.CacheItem>> items, Func<CacheImageLoader.CacheItem, ulong> itemSizeEvaluator, ulong sizeToFree);
    }
}
